...
final class AutoloadResolver
{
    ...
    private function scanFileForClasses(string $filePath): void
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            // Detect the namespace declaration.
    ...
    /**
     * Returns the registered PSR-4 rules for debugging.
     */
    public function getPsr4Rules(): array
    {
        return $this->psr4;
    }

    /**
     * Returns the registered classmap for debugging.
     */
